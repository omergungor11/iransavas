      ...
      <div className="mx-auto max-w-7xl px-4 py-6">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <div className="flex items-center gap-2">
                <h2 className="text-lg font-bold text-foreground">Hava Sahası & Uçuş Takibi</h2>
                <span className="px-2 py-0.5 rounded text-[10px] font-bold bg-yellow-600 text-white uppercase tracking-wider">
                  Live
                </span>
              </div>
              <p className="text-xs text-muted-foreground">Bölgedeki canlı hava trafiği — Flightradar24</p>
            </div>
          </div>
          <div className="flex items-center gap-2">
            <button
              ...
              aria-label={expanded ? "Hava sahası panelini küçült" : "Hava sahası panelini tam ekran yap"}
        ...
        <div className={`relative rounded-lg overflow-hidden border border-border bg-card transition-all ${expanded ? "h-[80vh]" : "h-[450px]"}`}>
          <iframe
            ...
            allowFullScreen
            title="Flightradar24 Canlı Uçuş Haritası"
          />
          {/* Live indicator */}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
          ...
          >
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="text-xs text-muted-foreground mt-0.5">Sansürsüz ve filtresiz ADS-B verileri — askerî uçuşlar dahil tüm hava trafiği</p>
            </div>
          ...
          >
            ...
            <div className="flex-1 min-w-0">
              <div className="flex items-center gap-2">
                <h3 className="text-sm font-bold text-foreground">NOTAM Uyarıları</h3>
                <span className="h-1.5 w-1.5 rounded-full bg-yellow-500" />
              </div>
              <p className="text-xs text-muted-foreground mt-0.5">FAA NOTAM — hava sahası kapanışları, uçuşa yasak bölgeler ve acil uyarılar</p>
            </div>
        ...
        <p className="text-[10px] text-zinc-600 mt-3">
          Uçuş verileri Flightradar24 tarafından sağlanmaktadır. Askerî uçuşlar filtrelenebilir — tam veri için ADS-B Exchange kullanın.
        </p>
      </div>
    </section>
  );
